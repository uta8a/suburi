...
const Title = () => {
  return (
    <h1 className="text-center pt-6 text-white text-3xl">Rules</h1>
  )
}
    ...
    <>
      ...
      <div className="px-10 flex flex-col items-center justify-center text-white text-2xl">
        ...
        <ul className="px-10 list-inside flex flex-col">
          ...
          <li>- DoSなどの過度な負荷のかかる攻撃や、スコアサーバ自体への攻撃を禁止します。また、ツールを使ったスキャンはDoSとみなされることがあります。</li>
          <li>- flagのフォーマットは<code className="bg-gray-700">{FLAG_FORMAT}</code>です。</li>
